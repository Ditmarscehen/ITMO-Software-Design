...
public class IntegrationTest {
    ...
    @Order(2)
    public void testMin() {
        Optional<Product> expectedMin = commandsExecutor.getProducts().stream().min(Comparator.comparing(Product::getPrice));
    ...
    @Order(3)
    public void testMax() {
        Optional<Product> expectedMax = commandsExecutor.getProducts().stream().max(Comparator.comparing(Product::getPrice));
